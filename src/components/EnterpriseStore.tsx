        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 md:py-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <div className="bg-orange-100 text-orange-700 px-3 py-2 rounded-xl flex items-center space-x-1.5 shadow-sm">
                <FaFire className="w-4 h-4 flex-shrink-0" />
                <span className="font-bold text-sm">{userBalance?.fuel || 0}</span>
                <span className="text-xs hidden sm:inline">Fuel</span>
              </div>
              <div className="bg-purple-100 text-purple-700 px-3 py-2 rounded-xl flex items-center space-x-1.5 shadow-sm">
                <FaGem className="w-4 h-4 flex-shrink-0" />
                <span className="font-bold text-sm">{userBalance?.premium || 0}</span>
                <span className="text-xs hidden sm:inline">Premium</span>
              </div>
              <div className="bg-green-100 text-green-700 px-3 py-2 rounded-xl flex items-center space-x-1.5 shadow-sm hidden md:flex">
                <FaCreditCard className="w-4 h-4 flex-shrink-0" />
                <span className="font-bold text-sm">{paymentMethods?.length || 0}</span>
                <span className="text-xs">Cards</span>
              </div>
              <button
                onClick={() => setShowPremiumModal(true)}
                className="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white px-3 sm:px-4 py-2 rounded-xl font-semibold transition-all flex items-center space-x-1.5 sm:space-x-2 shadow-md text-sm"
              >
                <FaPlus className="w-3 h-3 sm:w-4 sm:h-4" />
                <span className="hidden xs:inline">Buy Premium</span>
