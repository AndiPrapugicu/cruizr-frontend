      ...
      <div className="mb-6 sm:mb-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="bg-blue-500 hover:bg-blue-600 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl flex items-center gap-2 transition-colors text-sm sm:text-base whitespace-nowrap min-h-[44px]"
          >
            <FaPlus />
            Create Poll
          </button>
